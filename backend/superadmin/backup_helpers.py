...
BACKUP_SYSTEM_TABLES_EXCLUDE = {
    ...
    "auth_permission",
    "auth_group",
    # Log operacional — não é cadastro da loja e mistura conversas no ZIP
...
BACKUP_TIPO_APP_TABLE_PREFIXES = {
    "clinica-de-estetica": ("clinica_beleza_", "whatsapp_", "nfse_integration_"),
    "clinica-estetica": ("clinica_beleza_", "whatsapp_", "nfse_integration_"),
    "clinica-da-beleza": ("clinica_beleza_", "whatsapp_", "nfse_integration_"),
    "clinica-beleza": ("clinica_beleza_", "whatsapp_", "nfse_integration_"),
