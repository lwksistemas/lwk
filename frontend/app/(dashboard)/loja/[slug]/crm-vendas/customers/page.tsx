...
const EMPTY_FORM: ContaFormData = {
  nome: '', razao_social: '', cnpj: '', inscricao_estadual: '', segmento: '',
  ...
  const openModal = (type: ModalType, conta?: Conta) => {
    ...
    if (type === 'edit' && conta) {
      setFormData({
        ...
        inscricao_estadual: conta.inscricao_estadual || '', segmento: conta.segmento || '',
          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                {['Nome da Conta', 'Segmento', 'Email', 'Cidade'].map((h) => (
