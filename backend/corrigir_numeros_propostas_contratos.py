...
def corrigir_numeros_propostas():
    ...
    for loja in lojas:
        ...
        # Buscar todas as propostas da loja ordenadas por ID (ordem de criação)
        propostas = Proposta.objects.filter(loja_id=loja.id).order_by('id')
...
def corrigir_numeros_contratos():
    ...
    for loja in lojas:
        ...
        # Buscar todos os contratos da loja ordenados por ID (ordem de criação)
        contratos = Contrato.objects.filter(loja_id=loja.id).order_by('id')
