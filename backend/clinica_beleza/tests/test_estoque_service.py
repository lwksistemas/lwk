...
from clinica_beleza.estoque_movimentacao_service import (
    EstoqueMovimentacaoError,
...
class RegistrarMovimentacaoTests(SimpleTestCase):
    ...
    def test_entrada_incrementa(self, MockMov):
        ...
        produto.save.assert_called_once()

    @patch('clinica_beleza.estoque_movimentacao_service.MovimentacaoEstoque')
    def test_saida_decrementa(self, MockMov):
    ...
    @patch('clinica_beleza.estoque_movimentacao_service.MovimentacaoEstoque')
    def test_ajuste_seta_valor(self, MockMov):
        produto = self._produto(50)
    ...
    @patch('clinica_beleza.estoque_movimentacao_service.MovimentacaoEstoque')
    def test_movimentacao_criada_com_campos(self, MockMov):
        produto = self._produto(100)
