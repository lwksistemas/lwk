...
/**
 * Modal para configurar dias e horários de trabalho por profissional (Clínica da Beleza).
 * GET/PUT /clinica-beleza/professionals/<id>/horarios-trabalho/
 */
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {DIAS_SEMANA.map((d) => (
                <div
                  key={d.value}
                  className="flex flex-wrap items-center gap-2 p-3 rounded-lg bg-gray-50 dark:bg-neutral-700/50"
                >
