...
class ProfessionalCommissionView(GetObjectMixin, APIView):
    ...
    def post(self, request, pk):
        ...
        from .comissao_config_service import salvar_comissoes_profissional
        ...
        try:
            data, error = salvar_comissoes_profissional(professional, request.data)
            if error:
                payload, code = error
