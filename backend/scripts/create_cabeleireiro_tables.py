#!/usr/bin/env python
"""
Script para criar tabelas do cabeleireiro em todas as lojas de cabeleireiro.
Uso: python backend/scripts/create_cabeleireiro_tables.py
"""
import os
import sys
import django
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                if not cursor.fetchone():
                    print(f'  ⚠️  Schema {schema_name} não existe')
                    continue
                ...
                if existing_tables:
                    print(f'  ✅ Tabelas já existem: {", ".join(existing_tables)}')
                else:
                    print('  📦 Criando tabelas do cabeleireiro...')
