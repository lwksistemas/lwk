#!/usr/bin/env python
"""
Script para excluir a loja órfã ID 108 (FELIX REPRESENTACOES E COMERCIO LTDA).
Criada durante teste de criação de loja com arquivos corrompidos.
"""
import os
import sys
import django
...
def excluir_loja_108():
    """Exclui a loja órfã ID 108."""
    try:
        loja = Loja.objects.get(id=108)
        print(f"\n🔍 Loja encontrada:")
        print(f"   - ID: {loja.id}")
        ...
        print("\n" + "="*80)
        print("✅ LOJA ÓRFÃ 108 EXCLUÍDA COM SUCESSO")
        print("="*80)
        
    except Loja.DoesNotExist:
        print("\n❌ Loja ID 108 não encontrada")
