        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={openNew} className="px-3 sm:px-4 py-2 bg-white text-sky-700 font-semibold rounded-md hover:bg-sky-50 transition-colors text-sm flex items-center gap-1 shadow active:scale-95 ml-auto"><Plus className="w-4 h-4" /> Nova tarefa</button>
            </div>
          </div>
        </div>
      </div>
