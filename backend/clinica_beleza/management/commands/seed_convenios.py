...
TABELA_POR_CONVENIO = {
    "Unimed": [
        ...
        ("Imunidade", "percentual", Decimal("80.00")),
        ("Energia e Foco", "percentual", Decimal("78.00")),
        ("Detox", "percentual", Decimal("76.00")),
    ],
    "Santa Casa": [
        ...
        ("Imunidade", "percentual", Decimal("71.00")),
        ("Energia e Foco", "percentual", Decimal("70.00")),
        ("Detox", "percentual", Decimal("68.00")),
    ],
    "Bradesco Saúde": [
