...
Uso:
    ...
    python manage.py ensure_professional_commission_convenio --slug beleza
"""
                ...
                with conn.cursor() as cursor:
                    ...
                    if not column_exists(
                        ...
                        cursor.execute("""
                            ...
                            REFERENCES clinica_beleza_convenios(id) ON DELETE CASCADE
                        """)
                        cursor.execute("""
                            CREATE INDEX IF NOT EXISTS
                            clinica_beleza_prof_comm_convenio_id_idx
                            ON clinica_beleza_professional_commissions (convenio_id)
                        """)
                    cursor.execute(
                        """
