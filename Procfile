...
release: cd backend && python fix_suporte_migration.py 2>/dev/null || true && python manage.py migrate --noinput && python manage.py migrate_all_lojas && python manage.py setup_initial_data
