...
from .views_pedido_compra import (
    ...
    PedidoCompraBuscarPacientesView,
...
urlpatterns = [
    ...
    path("patients/<int:pk>/prazo-pagamento/", PatientPrazoPagamentoView.as_view(), name="patient-prazo-pagamento"),
    ...
    path("consultas/<int:consulta_id>/prescricoes/<int:pk>/", ConsultaPrescricaoDeleteView.as_view(), name="consultas-prescricao-delete"),
    ...
    path("payments/<int:pk>/enviar-recibo/", PaymentEnviarReciboView.as_view(), name="payments-enviar-recibo"),
    path("payments/<int:pk>/recibo-html/", PaymentReciboHtmlView.as_view(), name="payments-recibo-html"),
    ...
    path("estoque/pedidos/buscar-pacientes/", PedidoCompraBuscarPacientesView.as_view(), name="estoque-pedidos-buscar-pacientes"),
