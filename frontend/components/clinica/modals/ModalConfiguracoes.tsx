        ...
        {activeTab === 'geral' && (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <a
                href={`/loja/${loja.slug}/clinica-estetica/configuracoes/login`}
                className="block bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md hover:border-pink-500/30 transition-all group"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                      Personalize a aparência da tela de login da sua clínica
                    </p>
                    <ul className="space-y-1">
                      <li className="text-xs text-gray-500 dark:text-gray-400">• Logo</li>
                      <li className="text-xs text-gray-500 dark:text-gray-400">• Cores e identidade visual</li>
                    </ul>
                  </div>
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-pink-500 shrink-0 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 opacity-50">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="p-2.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Em breve mais opções de configuração
                    </p>
                  </div>
                </div>
              </div>
