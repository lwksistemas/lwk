# Migração manual: Adicionar índices para performance (multi-tenant)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crm_vendas', '0016_add_cpf_cnpj_to_lead'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='conta',
            index=models.Index(fields=['loja_id', 'vendedor'], name='crm_conta_loja_vend_idx'),
        ),
        migrations.AddIndex(
            model_name='conta',
        ...
        migrations.AddIndex(
            model_name='contato',
            index=models.Index(fields=['loja_id', 'conta'], name='crm_contato_loja_conta_idx'),
        ),
        migrations.AddIndex(
            model_name='contato',
        ...
        migrations.AddIndex(
            model_name='lead',
            index=models.Index(fields=['loja_id', 'vendedor'], name='crm_lead_loja_vend_idx'),
        ),
        migrations.AddIndex(
            model_name='lead',
        ...
        migrations.AddIndex(
            model_name='lead',
            index=models.Index(fields=['loja_id', 'conta'], name='crm_lead_loja_conta_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='oportunidade',
            index=models.Index(fields=['loja_id', 'vendedor'], name='crm_opor_loja_vend_idx'),
        ),
        migrations.AddIndex(
            model_name='oportunidade',
            index=models.Index(fields=['loja_id', 'lead'], name='crm_opor_loja_lead_idx'),
        ),
        migrations.AddIndex(
            model_name='oportunidade',
        ...
        migrations.AddIndex(
            model_name='oportunidade',
            index=models.Index(fields=['loja_id', 'etapa', 'vendedor'], name='crm_opor_loja_etapa_vend_idx'),
        ),
        migrations.AddIndex(
            model_name='oportunidade',
        ...
        migrations.AddIndex(
            model_name='atividade',
            index=models.Index(fields=['loja_id', 'oportunidade'], name='crm_ativ_loja_opor_idx'),
        ),
        migrations.AddIndex(
            model_name='atividade',
            index=models.Index(fields=['loja_id', 'lead'], name='crm_ativ_loja_lead_idx'),
        ),
        migrations.AddIndex(
            model_name='atividade',
