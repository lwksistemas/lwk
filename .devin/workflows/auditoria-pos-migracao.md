---
description: Executar auditoria pós-migração de fotos e prontidão DPS/RTC
---

# Auditoria pós-migração — Clínica da Beleza

Este runbook deve ser executado após deploy das correções de migrações 0066/0067 e habilitação do NFS-e Padrão Nacional. As fotos ficam no servidor de mídia da clínica.
...
## Passo 2 — Auditar prontidão DPS/RTC
...
## Passo 3 — Validar upload de fotos pelo painel
...
## Passo 4 — Validar upload público via QR
