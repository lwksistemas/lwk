...
router.register(r"tipos-consulta", TipoConsultaViewSet, basename="clinica-geral-tipos-consulta")
router.register(r"convenios", ConvenioConsultorioViewSet, basename="clinica-geral-convenios")
