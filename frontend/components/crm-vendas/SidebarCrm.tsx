...
export default function SidebarCrm({ lojaNome, onLogout }: SidebarCrmProps) {
  ...
  return (
    <>
      ...
      {showNotifications && (
        <div className="fixed top-4 right-4 z-50 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4 max-w-sm animate-slide-in">
