        ...
        {opcoes.map((op) => {
          ...
          return (
            <Link
              key={op.href}
              href={op.href}
              className="block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md hover:border-[#8B3D52]/40 dark:hover:border-[#8B3D52]/50 transition-all group"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{op.titulo}</h2>
                  </div>
                ...
                <ChevronRight
                  size={20}
                  className="text-gray-400 group-hover:text-[#8B3D52] shrink-0 transition-colors"
                />
              </div>
            </Link>
          );
