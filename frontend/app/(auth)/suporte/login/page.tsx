...
export default function SuporteLoginPage() {
  ...
  useEffect(() => {
    if (config.login_background) {
      ...
      // Também disparar fetch via Image() para cache do browser
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      localStorage.removeItem('login_lembrar_pass_suporte');
            ...
            {showMfa && (
              <div>
                ...
                <input
                  ...
                  type="text"
                  autoComplete="off"
                  className="block w-full px-3 py-3 min-h-[44px] text-base text-gray-900 border border-gray-300 rounded-md bg-white font-mono uppercase"
